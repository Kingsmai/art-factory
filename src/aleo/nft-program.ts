export const NFTProgramId = 'privacy_yizlab_nft_test.aleo';

export const NFTProgram = `program privacy_yizlab_nft_test.aleo;
...
function initialize_collection:
    ...
    assert.eq self.caller aleo1enx7gqxyxf64uvac3akg32xflqlle87ywxdm7acqk4zqmqttngxql46kd0;
    async initialize_collection r0 r1 r2 into r3;
    output r3 as privacy_yizlab_nft_test.aleo/initialize_collection.future;
...
function add_nft:
    ...
    output r4 as privacy_yizlab_nft_test.aleo/add_nft.future;
...
function add_minter:
    ...
    output r3 as privacy_yizlab_nft_test.aleo/add_minter.future;
...
function update_toggle_settings:
    ...
    output r1 as privacy_yizlab_nft_test.aleo/update_toggle_settings.future;
...
function set_mint_block:
    ...
    output r1 as privacy_yizlab_nft_test.aleo/set_mint_block.future;
...
function update_symbol:
    ...
    output r1 as privacy_yizlab_nft_test.aleo/update_symbol.future;
...
function update_base_uri:
    ...
    output r1 as privacy_yizlab_nft_test.aleo/update_base_uri.future;
...
function open_mint:
    ...
    output r4 as privacy_yizlab_nft_test.aleo/open_mint.future;
...
function mint:
    ...
    output r7 as privacy_yizlab_nft_test.aleo/mint.future;
...
function claim_nft:
    ...
    output r6 as privacy_yizlab_nft_test.aleo/claim_nft.future;
...
function authorize:
    ...
    output r2 as privacy_yizlab_nft_test.aleo/authorize.future;
...
function transfer_public:
    ...
    output r5 as privacy_yizlab_nft_test.aleo/transfer_public.future;
...
function convert_private_to_public:
    ...
    output r3 as privacy_yizlab_nft_test.aleo/convert_private_to_public.future;
...
function convert_public_to_private:
    ...
    output r5 as NFT.record;
    output r6 as privacy_yizlab_nft_test.aleo/convert_public_to_private.future;
